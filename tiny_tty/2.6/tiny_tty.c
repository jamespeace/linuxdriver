...
#ifdef __UART__ // 08-13-2010 by jiunnder2000@yahoo.com.tw
#include <asm/io.h>
...
#endif // End of --- 08-13-2010 jiunnder2000@yahoo.com.tw
...
#ifndef __UART__ // 08-13-2010 masked by jiunnder2000@yahoo.com.tw
...
#else
#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,18) //jiunnder2000@yahoo.com.tw, 08-10-2010
...
static int tiny_open(struct tty_struct *tty, struct file *file)
{
	...
	if (tiny->open_count == 1) {
		...
		init_timer(tiny->timer); //jiunnder2000@yahoo.com.tw, 08-10-2010
...
#endif
{
	 ...
	 */
#ifndef __UART__ // 08-13-2010 comment out by jiunnder2000@yahoo.com.tw
	printk("<1>%s[%d]\n", __FUNCTION__, __LINE__);
	for (i = 0; i < count; ++i)
		printk("%02x ", buffer[i]);
	printk("\n");
#else // 08-13-2010, To do: write data into UART
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(2,6,31) //jiunnder2000@yahoo.com.tw, 11-27-2011
...
static int __init tiny_init(void)
{
	 ...
	 * structure above... */
	// jiunnder2000@yahoo.com.tw, 08-10-2010, move to serial_ops
...
#ifdef __UART__ // 08-13-2010, To do: Initialize UART

	// To do: Initial the UART n,8,1, 2400 baud

	// To do: request and enable interrupt for UART
...
#ifdef __UART__ // 08-13-2010, To do: free IRQ
